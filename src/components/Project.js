...
export default function Project() {
    return (
        <>
            <div id="project">
                <h2 className="p-1 m-auto rounded-tl-full text-center rounded-tr-full mt-5 font-bold text-2xl text-green-800 bg-blue-100 w-2/6 text-xl lg:text-2xl">
                    Project
                </h2>
                <div className="bg-blue-100 p-5 text-center text-xl mx-5 rounded-2xl font-semibold">
                    <h2 className="p-1 font-bold text-2xl text-blue-950 m-auto text-xl lg:text-2xl">
