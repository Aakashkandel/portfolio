...
import footerImage from './images/aakashfooter.png'

export default function Footer() {
    return (
        <>

            <footer id="footer" class="w-full bg-gray-900">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
                        <a href="https://pagedone.io/" class="flex justify-center ">
                            <img class="w-28 h-28 border-4 border-gray-500 rounded-full" src={footerImage} />
                        ...
                        <ul
                            ...
                            <li class="sm:my-0 my-2"><a href="#skill" class="text-white hover:text-gray-400">skills</a>
                            </li>
                            <li><a href="#project" class="text-white hover:text-gray-400">Project</a></li>
                            <li class="sm:my-0 my-2"><a href="#education" class="text-white hover:text-gray-400">Education</a>
                            </li>
                            <li><a href="#contact" class="text-white hover:text-gray-400">Contact</a></li>
                        </ul>
                        <div class="flex  space-x-4 sm:justify-center  ">
                            <a href="https://twitter.com/AakashKandel97"
                            ...
                            <a href="https://www.instagram.com/aakash__kandel/"
                                class="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-indigo-600">
                            ...
                            <a href="https://www.linkedin.com/in/aakash-kandel-b97b1b2a1/"
                                class="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-indigo-600">
                            ...
                            <a href="https://www.facebook.com/alvir15/"
                                class="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-indigo-600">
                                <svg fill="#030113" class="w-[1.5rem] h-[1.5rem] text-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#030113" stroke-width="0.624">
                    ...
                    <div class="py-7 border-t border-gray-700">
                        <div class="flex items-center justify-center">
                            <span class="text-gray-400 ">© Aakash Kandel 2024, All rights reserved.</span>
                        </div>
                    </div>
                </div>
            </footer>
